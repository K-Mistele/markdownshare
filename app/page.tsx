...
import { ArrowRightIcon, EditIcon, ShareIcon, UsersIcon, EyeIcon, LockIcon } from "lucide-react"
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="container flex-1 space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        <div className="mx-auto flex max-w-[980px] flex-col items-center gap-2 text-center">
          ...
          <p className="max-w-[750px] text-lg text-muted-foreground sm:text-xl">
            ...
            Support for MDX, syntax highlighting, comments, and powerful sharing controls.
          </p>
      ...
      <section className="container space-y-6 py-8 md:py-12 lg:py-24">
        ...
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              <CardDescription>
                Powerful markdown editor with syntax highlighting, live preview, and full MDX support.
              </CardDescription>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              <CardDescription>
                Public, private, or link-only sharing with password protection and access controls.
              </CardDescription>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              <CardDescription>
                Syntax-highlighted code blocks, mathematical expressions, and rich media support.
              </CardDescription>
            </CardContent>
          </Card>
          <Card>
          ...
          <Card>
            ...
            <CardContent>
              <CardDescription>
                Write interactive content with React components, charts, and custom elements.
              </CardDescription>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="container py-8 md:py-12 lg:py-24">
        <div className="mx-auto flex max-w-[980px] flex-col items-center gap-4 text-center">
          ...
          <p className="max-w-[750px] text-lg text-muted-foreground sm:text-xl">
            Join thousands of teams already using MarkdownShare for their documentation and collaboration needs.
          </p>
          <Button size="lg" asChild className="mt-4">
            <Link href="/auth/signup">
              Create Your First Document <ArrowRightIcon className="ml-2 h-4 w-4" />
            </Link>
          </Button>
        </div>
      </section>
